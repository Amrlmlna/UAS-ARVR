...
public class LoadMusic : MonoBehaviour
{
    ...
    void Start()
    {
        folderName = "My AR Audio Project";
    ...
    private IEnumerator LoadAllAudioFiles()
    {
        ...
        if (queue.Count == 0)
        {
            Debug.LogWarning("No audio files found in: " + folderPath + ". Please add .mp3, .wav, or .ogg files to this folder.");
        }
    }
